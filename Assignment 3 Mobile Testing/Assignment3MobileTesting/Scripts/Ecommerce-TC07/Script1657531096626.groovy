...
if (Mobile.verifyElementVisible(findTestObject('Object Repository/Checkout/CEK PRODUCT IN CART'), GlobalVariable.timeOUT, 
    ...
    Mobile.tap(findTestObject('Object Repository/Checkout/BUTTON DELETE CART'), GlobalVariable.timeOUT)

    Mobile.tap(findTestObject('Object Repository/Checkout/BUTTON DELETE CART - YES'), GlobalVariable.timeOUT)
}

Mobile.verifyElementExist(findTestObject('Object Repository/Checkout/CART EMPTY _ IMG'), GlobalVariable.timeOUT)

Mobile.verifyElementExist(findTestObject('Object Repository/Checkout/ART EMPTY - Whoops, your cart is empty'), GlobalVariable.timeOUT)

Mobile.tap(findTestObject('Object Repository/Checkout/CART EMPTY - CONTINUE SHOPPING'), GlobalVariable.timeOUT)
...
for (def rowNum = 1; rowNum <= findTestData('Order').getRowNumbers(); rowNum++) {
    if (findTestData('Order').getValue('ORDER', rowNum) == 'Y') {
        ...
        Mobile.setText(findTestObject('Object Repository/Checkout/SEARCH TEXT FIELD'), findTestData('Order').getValue('keyword', 
                rowNum), GlobalVariable.timeOUT)
        ...
        Mobile.setText(findTestObject('Object Repository/Checkout/Number of Order field'), findTestData('Order').getValue(
                'quantity', rowNum), GlobalVariable.timeOUT)
        ...
        } else if (Mobile.verifyElementExist(findTestObject('Object Repository/Checkout/CART3'), GlobalVariable.timeOUT, 
            FailureHandling.OPTIONAL)) {
        ...
        } else if (Mobile.verifyElementExist(findTestObject('Object Repository/Checkout/CART2'), GlobalVariable.timeOUT, 
            FailureHandling.OPTIONAL)) {
