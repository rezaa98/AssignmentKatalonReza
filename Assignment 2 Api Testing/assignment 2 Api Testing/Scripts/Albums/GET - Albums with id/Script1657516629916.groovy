...
WebUI.comment('Do Get Method for Endpoint Albums with ID')

respon1 = WS.sendRequest(findTestObject('Albums/GET - Albums with id', [('age') : 18, ('gender') : 'MALE', ('username') : 'mimi'
            , ('password') : '123456789']))
