...
Mobile.tap(findTestObject('Object Repository/Cek Category/Button Search'), GlobalVariable.timeOUT)
Mobile.setText(findTestObject('Object Repository/Cek Category/Text Field- Search'), 'Apple Watch', GlobalVariable.timeOUT)
...
Mobile.tap(findTestObject('Object Repository/Cek Category/Button Search'), GlobalVariable.timeOUT)
Mobile.setText(findTestObject('Object Repository/Cek Category/Text Field- Search'), 'Robot Vacuum', GlobalVariable.timeOUT)
