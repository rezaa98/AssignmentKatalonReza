...
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/Screen Verif - Category'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/Screen Verif - Electronics  Gadgets'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/CONTENT - U17 USB Portable M3 HUmidifier Air Purifier LED Night Light 200ML'), GlobalVariable.timeOUT)
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/CONTENT - Apple watch series 3 GPS 42mm Black'), GlobalVariable.timeOUT)
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/CONTENT - Mini Digital Speaker TD-V26 USB FM Radio SD TF Card MP3 - Red'), GlobalVariable.timeOUT)
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/CONTENT - LED TV 43 Inch Smart TV TCL 43E3 UHD 4K Dolby Sound'), GlobalVariable.timeOUT)
...
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/Screen Verif- Home  Furniture'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/CONTENT2 - Bathroom Toilet Wall Shelves A289') , GlobalVariable.timeOUT)
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/CONTENT2 - Copper Light 3 Battery Warm White - Fairy Light Battery') , GlobalVariable.timeOUT)
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/CONTENT2 - Bed Mosquito Net KL200  200 x 200 cm') , GlobalVariable.timeOUT)
Mobile.verifyElementExist(findTestObject('Object Repository/Cek Category/CONTENT2 - Robot Vacuum Cleaner Wellcomm Home 2.0') , GlobalVariable.timeOUT)
