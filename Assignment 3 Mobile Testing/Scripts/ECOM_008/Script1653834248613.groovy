...
Mobile.waitForElementPresent(findTestObject('Object Repository/Checkout/Verify SCREEN - Shopping Cart'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)

if (Mobile.verifyElementVisible(findTestObject('Object Repository/Checkout/CEK PRODUCT IN CART'), GlobalVariable.timeOUT, FailureHandling.OPTIONAL)) {
    Mobile.tap(findTestObject('Object Repository/Checkout/BUTTON - CHECKOUT'), GlobalVariable.timeOUT)
    Mobile.verifyElementVisible(findTestObject('Object Repository/Checkout/screen verif - Checkout'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)
    ...
    Mobile.waitForElementPresent(findTestObject('Object Repository/Checkout/POPUP CHECKOUT - Process Checkout'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)

    Mobile.tap(findTestObject('Object Repository/Checkout/POPUP CHECKOUT - YES'), GlobalVariable.timeOUT)
    Mobile.waitForElementPresent(findTestObject('Object Repository/Checkout/POPUP WAITING CHECKOUT - Please wait'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)
    Mobile.waitForElementPresent(findTestObject('Object Repository/Checkout/POPUP SUKSES ORDER - Congratulation'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)
	
	if (Mobile.verifyElementNotVisible(findTestObject('Object Repository/Checkout/POPUP SUKSES ORDER - Congratulation'), GlobalVariable.timeOUT, FailureHandling.OPTIONAL)) {
		Mobile.tap(findTestObject('Object Repository/Checkout/BUTTON - PROCESS CHECKOUT'), GlobalVariable.timeOUT)
		Mobile.waitForElementPresent(findTestObject('Object Repository/Checkout/POPUP CHECKOUT - Process Checkout'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)
		Mobile.tap(findTestObject('Object Repository/Checkout/POPUP CHECKOUT - YES'), GlobalVariable.timeOUT)
