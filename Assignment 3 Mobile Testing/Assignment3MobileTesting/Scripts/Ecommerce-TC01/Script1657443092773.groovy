...
for (def rowNum = 1; rowNum <= findTestData('Profile').getRowNumbers(); rowNum++) {
    WebUI.comment('do If Statement in Looping')
    ...
    if (findTestData('Profile').getValue('ACTIVE', rowNum) == 'Y') {
        ...
        Mobile.verifyElementVisible(findTestObject('Object Repository/Cek Profile/VERIF SCREEN - User Profile'), GlobalVariable.timeOUT, 
            FailureHandling.STOP_ON_FAILURE)
        ...
        Mobile.setText(findTestObject('Object Repository/Cek Profile/android.widget.EditText'), findTestData('Profile').getValue(
                'Nama', rowNum), GlobalVariable.timeOUT)
        ...
        Mobile.clearText(findTestObject('Object Repository/Cek Profile/android.widget.EditText - your.emailgmail.com'), 
            GlobalVariable.timeOUT)

        Mobile.setText(findTestObject('Object Repository/Cek Profile/android.widget.EditText'), findTestData('Profile').getValue(
                'Email', rowNum), GlobalVariable.timeOUT)
        ...
        Mobile.setText(findTestObject('Object Repository/Cek Profile/android.widget.EditText'), findTestData('Profile').getValue(
                'HP', rowNum), GlobalVariable.timeOUT)
        ...
        Mobile.setText(findTestObject('Object Repository/Cek Profile/android.widget.EditText'), findTestData('Profile').getValue(
                'Alamat', rowNum), GlobalVariable.timeOUT)

        Mobile.tap(findTestObject('Object Repository/Cek Profile/android.widget.Button - OK'), GlobalVariable.timeOUT)

        Mobile.tap(findTestObject('Object Repository/Cek Profile/android.widget.ImageButton'), GlobalVariable.timeOUT)

        Mobile.verifyElementText(findTestObject('Cek Profile/TextView - Nama'), findTestData('Profile').getValue('Nama', 
                rowNum), FailureHandling.STOP_ON_FAILURE)

        Mobile.verifyElementText(findTestObject('Cek Profile/TextView - Email'), findTestData('Profile').getValue('Email', 
                rowNum), FailureHandling.STOP_ON_FAILURE)

        Mobile.verifyElementText(findTestObject('Cek Profile/TextView - HP'), findTestData('Profile').getValue('HP', rowNum), 
            FailureHandling.STOP_ON_FAILURE)

        Mobile.verifyElementText(findTestObject('Cek Profile/TextView - Alamat'), findTestData('Profile').getValue('Alamat', 
                rowNum), FailureHandling.STOP_ON_FAILURE)
    }
}
