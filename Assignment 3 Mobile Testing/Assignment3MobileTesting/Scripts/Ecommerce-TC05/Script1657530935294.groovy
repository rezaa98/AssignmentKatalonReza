...
Mobile.tap(findTestObject('Cek Kategori/Button Menu Category'), GlobalVariable.timeOUT)

Mobile.waitForElementPresent(findTestObject('Cek Kategori/Screen Verif - Category'), GlobalVariable.timeOUT)
...
WebUI.comment('def variable StartX, EndX, StartY, and EndY')
...
WebUI.comment('do Swipe page')

Mobile.swipe(startX, endY, endX, startY)

Mobile.tap(findTestObject('Cek Kategori/Kategori - Electronics Gadgets'), GlobalVariable.timeOUT)

Mobile.waitForElementPresent(findTestObject('Cek Kategori/Verif Screen- Electronics Gadgets'), GlobalVariable.timeOUT)

Mobile.verifyElementExist(findTestObject('Cek Kategori/Verif Screen- Electronics Gadgets'), GlobalVariable.timeOUT, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementExist(findTestObject('Cek Kategori/Objek_Samsung Galaxy S10 - Black'), GlobalVariable.timeOUT)

Mobile.verifyElementExist(findTestObject('Cek Kategori/Objek - U17 USB Portable M3 HUmidifier Air Purifier LED Night Light 200ML'), 
    GlobalVariable.timeOUT)

Mobile.verifyElementExist(findTestObject('Cek Kategori/Objek- Apple watch series 3 GPS 42mm Black'), GlobalVariable.timeOUT)

Mobile.verifyElementExist(findTestObject('Cek Kategori/Objek - Mini Digital Speaker TD-V26 USB FM Radio SD TF Card MP3 - Red'), 
    GlobalVariable.timeOUT)
