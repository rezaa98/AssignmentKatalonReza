...
if (true) {
    ...
    WebUI.setText(findTestObject('Page_CuraAppointment/txt_Comment'), 'Test1')
}
...
if (true) {
    WebUI.verifyMatch('Tokyo CURA Healthcare Center', WebUI.getText(findTestObject('Page_AppointmentConfirmation/lbl_Facility')), 
        false)
    ...
    WebUI.verifyMatch('10/08/2022', WebUI.getText(findTestObject('Page_AppointmentConfirmation/lbl_VisitDate')), false)

    WebUI.verifyMatch('Test1', WebUI.getText(findTestObject('Page_AppointmentConfirmation/lbl_Comment')), false)
}
